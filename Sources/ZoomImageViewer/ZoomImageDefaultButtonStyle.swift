...
/// The button style a zoom image viewer gives the buttons in its overlay, unless they set their own.
///
...
///
/// Used outside a viewer it follows the colour scheme it is given like any other style.
public struct ZoomImageDefaultButtonStyle: ButtonStyle {
    /// Creates the default button style for a zoom image viewer's overlay.
    public init() {}
